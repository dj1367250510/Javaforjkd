 ...
 * 入驻商家入口程序
 */
public class BusinessAdminEntey {
    ...
    public static void run(){
        ...
        int menu = 0;
        if (business != null){
            System.out.println("商家 "+business.getBusinessName()+" 欢迎您登录！");
            while (menu != 5){
                System.out.println(">>>一级菜单  1. 查看商家信息   2. 修改商家信息    3. 修改密码    4.所属产品管理   5. 退出系统");
